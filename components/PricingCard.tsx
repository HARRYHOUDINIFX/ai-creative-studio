...
const PricingCard: React.FC<PricingCardProps> = ({ item, cardId }) => {
  ...
  return (
    ...
    >
      ...
      <a
        href="#"
        className={`mt-auto block rounded-xl px-3 py-3 text-center text-sm font-semibold leading-6 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 transition-colors ${item.isHot
      ...
      >
        <Editable id={`${cardId}-cta`} tagName="span" text="상담 신청하기" />
      </a>
    </div>
  );
};
